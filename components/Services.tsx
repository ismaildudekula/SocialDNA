      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
            <div className="max-w-2xl">
                ...
                <h2 className="text-4xl md:text-5xl font-display font-bold text-dna-dark mb-4 leading-tight">
            ...
            {services.map((service, idx) => (
                ...
                >
                    ...
                    <div className="absolute bottom-0 left-0 p-8 w-full">
                        <div className="mb-4 text-white opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all origin-left">
                            {service.icon}
                        </div>
