...
const Stats: React.FC = () => {
  ...
  return (
    <section ref={ref} className="py-20 bg-dna-dark text-white relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-3 gap-12 text-center divide-y md:divide-y-0 md:divide-x divide-white/10">
          ...
          <motion.div
            ...
            className="p-6"
          >
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white/10 text-dna-primary mb-6">
