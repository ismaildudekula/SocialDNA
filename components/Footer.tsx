...
const Footer: React.FC = () => {
  return (
    <footer className="bg-dna-light border-t border-white/5 pt-16 pb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-12 text-sm">
             <div>
                ...
                <ul className="space-y-2 text-gray-500">
                    <li><a href="#" className="hover:text-dna-primary transition-colors">Best Digital Marketing Agency</a></li>
                    <li><a href="#" className="hover:text-dna-primary transition-colors">Know Us</a></li>
                    <li><a href="#" className="hover:text-dna-primary transition-colors">Case Studies</a></li>
                </ul>
             </div>
             <div>
                <h4 className="font-bold text-white mb-4">Services</h4>
                <ul className="space-y-2 text-gray-500">
                    <li><a href="#" className="hover:text-dna-primary transition-colors">Web Designing</a></li>
                    <li><a href="#" className="hover:text-dna-primary transition-colors">Web UI/UX</a></li>
                    <li><a href="#" className="hover:text-dna-primary transition-colors">Data Analytics</a></li>
                </ul>
             </div>
