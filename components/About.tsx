...
const About: React.FC = () => {
  return (
    <section id="about" className="py-24 bg-dna-dark relative">
       <div className="container mx-auto px-6">
         <div className="flex items-center gap-4 mb-12">
            <div className="h-px bg-white/10 flex-grow"></div>
            <h2 className="text-3xl font-display font-black text-white/20 uppercase tracking-widest">PR NEWS</h2>
            <div className="h-px bg-white/10 flex-grow"></div>
         </div>
         ...
         <div className="grid lg:grid-cols-3 gap-12">
            <motion.div 
                ...
                className="bg-dna-surface p-8 rounded-3xl border border-white/5 hover:border-dna-primary/30 transition-colors group"
            >
                <h3 className="text-xl font-bold mb-4 text-white">Catalyst of Transformation</h3>
            ...
            <motion.div 
                ...
                className="bg-dna-surface p-8 rounded-3xl border border-white/5 hover:border-dna-primary/30 transition-colors group"
            >
                <h3 className="text-xl font-bold mb-4 text-white">Revolutionary Innovations</h3>
                <p className="text-gray-400 leading-relaxed mb-6">
            ...
            <motion.div 
                ...
                className="bg-dna-surface p-8 rounded-3xl border border-white/5 hover:border-dna-primary/30 transition-colors group"
            >
                <h3 className="text-xl font-bold mb-4 text-white">360-degree Approach</h3>
                <p className="text-gray-400 leading-relaxed mb-6">
